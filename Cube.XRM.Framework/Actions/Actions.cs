...
namespace Cube.XRM.Framework
{
    ...
    public class Actions
    {
        ...
        /// <summary>
        /// Associates the specified entities.
        /// </summary>
        /// <param name="entities">The entities.</param>
        /// <param name="relationship">The relationship.</param>
        /// <returns>Result.</returns>
        /// <exception cref="Exception">Entity or service is null</exception>
        public virtual Result Associate(EntityReferenceCollection entities, Relationship relationship)
        {
            var watch = Stopwatch.StartNew();
            try
            {
                ...
                if (entities != null && entities.Count == 2 && xrmService != null)
                {
                    xrmService.Associate(entities[0].LogicalName, entities[0].Id, relationship, new EntityReferenceCollection() { entities[1] });

                    return new Result(false, string.Empty, null, logSystem);
                }
                else
                    throw new Exception("Entity or service is null");
            }
        ...
        /// <summary>
        /// Disassociates the specified entities.
        /// </summary>
        /// <param name="entities">The entities.</param>
        /// <param name="relationship">The relationship.</param>
        /// <returns>Result.</returns>
        /// <exception cref="Exception">Entity or service is null</exception>
        public virtual Result Disassociate(EntityReferenceCollection entities, Relationship relationship)
        {
            var watch = Stopwatch.StartNew();
            try
            {
                ...
                if (entities != null && entities.Count == 2 && xrmService != null)
                {
                    xrmService.Disassociate(entities[0].LogicalName, entities[0].Id, relationship, new EntityReferenceCollection() { entities[1] });
